...
# Olá, Fulano de Tal.
# A sua fatura com vencimento em 9 de Janeiro no valor
# de R$ 350,00 está fechada.
...
print('A sua fatura com vencimento em {} de {} no valor de R$ {} está fechada.'
      .format(dia, mes, valor))
